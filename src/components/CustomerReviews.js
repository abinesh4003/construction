  ...
  return (
    <section id="reviews" className="py-16 md:py-28 bg-white relative">
      <div className="container mx-auto px-4 sm:px-6">
        ...
        >
          <h2 className="text-3xl md:text-5xl font-bold text-[#F05A29] font-montserrat mb-4 md:mb-6">
            <span className="font-inter text-black">Our Happy </span> Customers
          </h2>
          <p className="text-base md:text-lg text-gray-600 max-w-3xl mx-auto px-4 inter">
          ...
          <AnimatePresence custom={direction} mode="popLayout">
            ...
            >
              {visibleReviews.map((review) => (
                <motion.div
                  key={review.id}
                  className="bg-gray-50 p-6 md:p-8 border border-gray-100 hover:shadow-xl transition-all flex flex-col h-full rounded-2xl"
                ...
                >
                  ...
                  <div className="flex-grow mb-4 md:mb-6">
                    <p className="text-sm md:text-base text-gray-600 italic relative pl-4 md:pl-6 inter before:absolute before:left-0 before:top-0 before:h-full before:w-px before:bg-[#F05A29]">
                      &quot;{review.content}&quot;
                    </p>
                  </div>
                  ...
                  <div className="flex items-center mt-auto">
                    ...
                    <div className="flex-1 min-w-0">
                      <h4 className="font-semibold text-sm md:text-base truncate montserrat">
                        {review.name}
                      </h4>
                      <p className="text-xs md:text-sm text-gray-500 truncate inter">
                        {review.role}
                      </p>
                    </div>
                  </div>
          ...
          <div className="flex justify-center mt-8 md:mt-12 gap-2">
            {reviews.map((_, index) => (
              <button
                ...
                className={`h-2 w-2 md:h-3 md:w-3 rounded-full transition-all ${currentIndex === index ? "bg-[#F05A29] md:w-6 w-4" : "bg-gray-300"
                  }`}
