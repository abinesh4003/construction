...
>
  ...
  {/* Content */}
  <div className="container mx-auto px-4 sm:px-6 h-full flex flex-col justify-center pt-24 sm:pt-32 pb-16 sm:pb-20">
    <motion.div 
    ...
    >
      ...
      >
        <button 
          className="bg-[#F05A29] hover:bg-[#e04a20] px-6 sm:px-8 py-3 sm:py-4 rounded-sm text-base sm:text-lg font-medium transition-all group flex items-center justify-center gap-2 w-full sm:w-auto"
          onClick={openDialog}
        >
          Get a Quote
  ...
  >
    <div className="animate-bounce flex flex-col items-center">
      <span className="text-white text-xs sm:text-sm mb-1 sm:mb-2">Scroll</span>
